...
cylinder_repository: CylinderRepository = CylinderRepository(database)
cylinder_service: CylinderService = CylinderService(cylinder_repository)
cylinder_controller = CylinderController(cylinder_service)
